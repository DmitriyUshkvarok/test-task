          ...
          return (
            ...
            ce(function (o, s, a, l) {
              ...
              if (o) {
                ...
                (g = _e(g === s ? g.splice(p, g.length) : g)),
                  i ? i(null, s, g, l) : M.apply(s, g);
            })
          );
        }
        function Te(e) {
  ...
  282: function (e, t, n) {
    ...
    function te() {
      this.addEventListener &&
        this.addEventListener('touchstart', ee, {
          passive: !0,
        });
    }
    class ne {
    ...
    class pe extends r.a {
      ...
      render() {
        return r.d`
            <div id="WTwrapper">
                <!--<a href="/tgr/${this.region}/meteo" title="${Object(u.a)('vai_al_meteo', 'goto')}">-->
                <div class="weather">
                    <div class="weather__img-wrapper">
                        <img width="32" height="32" src="//www.rai.it${this.weather.iconUrl.replace('[RESOLUTION]', '')}" alt="icona meteo"/>
                    </div>
                    ...
                    <div class="locations__dropdown dropdown-pane" id="province-dropdown" data-dropdown data-alignment="center" data-auto-focus="true">
                        <form class="locations__form">
                            <div class="locations__form__input-wrapper">
                                <input type="text" @input="${this.handleSuggestions}" placeholder="Cerca provincia" typw="text" />
            ...
            <div class="grid-container">
                <div class="grid-x align-center">
                    <div class="cell small-12 medium-8">
                        <form class="search__modal__form" role="search" method="get" action="${this.basepath}/ricerca.html">
                            <input type="search" name="q" placeholder="${Object(u.a)('cerca', 'search')}..." @input="${this._keyup}" .value="${this.q || ''}" id="search-input">
                ...
                t.subscribe(
                  p(r, function (e) {
                    if (l) {
                      ...
                      r.next(
                        n
                          ? n.apply(void 0, Object(i.h)([], Object(i.g)(t)))
                          : t,
                      );
                    }
                  }),
