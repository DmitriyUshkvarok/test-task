          ...
          return l
            ? ((o =
              ...
              void (r && 'function' == typeof r
                ? (r.apply(),
                  (s.handled || 'function' == typeof s.handled) &&
                    s.handled.apply())
                : (s.unhandled || 'function' == typeof s.unhandled) &&
                  s.unhandled.apply()))
    ...
    var i = {
      ...
      _watcher: function () {
        ...
        t(window).on('resize.zf.mediaquery', function () {
          ...
          i !== e.current &&
            (t(window).trigger('changed.zf.mediaquery', [i, e.current]),
            (e.current = i));
        });
      },
    };
        ...
        },
        {
          ...
          value: function (e, i) {
            ...
            e
              ...
              .parent()
              .addClass('is-active'),
              e.slideDown(n.options.slideSpeed, function () {
      ...
      _createClass(e, [
              ...
              .on('keydown.zf.accordionmenu', function (i) {
                ...
                a.each(function (e) {
                  return t(this).is(o)
                    ? ((n = a.eq(Math.max(0, e - 1))),
                      ...
                      t(this).children('[data-submenu]:visible').length &&
                        (s = o.find('li:first-child')),
                      t(this).is(':first-child')
                        ? (n = o.parents('li').first())
                        : n.children('[data-submenu]:visible').length &&
                          (n = n.find('li:last-child')),
                      void (
                        t(this).is(':last-child') &&
                        (s = o.parents('li').first().next('li'))
                      ))
                    : void 0;
                }),
                  Foundation.Keyboard.handleKey(i, 'AccordionMenu', {
                    open: function () {
                      r.is(':hidden') &&
                        (e.down(r), r.find('li').first().focus());
                    },
                    close: function () {
        ...
        },
        {
          ...
          value: function () {
            this.$element
              .find('[data-submenu]')
              .slideUp(this.options.slideSpeed);
          },
        },
        {
          key: 'toggle',
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            (this.$submenuAnchors = this.$element.find(
              ...
              (this.$submenus =
                this.$submenuAnchors.children('[data-submenu]')),
          ...
          value: function () {
            ...
            this.$submenuAnchors.each(function () {
              ...
              this.$element.parent().hasClass('is-drilldown') ||
                ((this.$wrapper = t(this.options.wrapper)
                  ...
                  Foundation.Keyboard.handleKey(i, 'Drilldown', {
                    next: function () {
                      o.is(e.$submenuAnchors) &&
                        (e._show(o),
                        o.on(Foundation.transitionend(o), function () {
                    ...
                    previous: function () {
                      e._hide(o.parent('ul')),
                        o
                          .parent('ul')
                          .on(Foundation.transitionend(o), function () {
                            setTimeout(function () {
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              ...
              (i['min-height'] =
                e * this.$menuItems[0].getBoundingClientRect().height + 'px'),
              (i['max-width'] =
        ...
        },
        {
          ...
          value: function () {
            ...
            for (
              ...
              !Foundation.Box.ImNotTouchingYou(this.$element) && this.counter;
                ...
                .on('keydown.zf.dropdown', function (i) {
                  ...
                  Foundation.Keyboard.handleKey(i, 'Dropdown', {
                    tab_forward: function () {
                      e.$element.find(':focus').is(s.eq(-1)) &&
                        (e.options.trapFocus
                          ? (s.eq(0).focus(), i.preventDefault())
                          : e.close());
                    },
                    tab_backward: function () {
                      (e.$element.find(':focus').is(s.eq(0)) ||
                        e.$element.is(':focus')) &&
                        (e.options.trapFocus
                          ? (s.eq(-1).focus(), i.preventDefault())
                          : e.close());
                    },
                    open: function () {
                      n.is(e.$anchor) &&
        ...
        },
        {
          ...
          value: function (t) {
            ...
            i = this.options.rules
              ? this.options.rules
              : this.$element.data('interchange').match(/\[.*?\]/g);
            for (var s in i) {
            ...
            if (this.currentPath !== e) {
              ...
              'IMG' === this.$element[0].nodeName
                ? this.$element
                    ...
                    .trigger(n)
                : e.match(/\.(gif|jpg|jpeg|tiff|png)([?#].*)?/i)
                  ? this.$element
                      .css({
      ...
      _createClass(e, [
            ...
            (this.options.isRevealed =
              ...
              this.options.transitionTime ||
                (this.options.transitionTime =
                  1e3 *
                  parseFloat(
                    window.getComputedStyle(t('[data-off-canvas-wrapper]')[0])
                      .transitionDuration
                  ));
          },
        },
            ...
            if (!this.$element.hasClass('is-open') && !this.isRevealed) {
              ...
              this.options.forceTop && t('body').scrollTop(0),
                Foundation.Move(
                  ...
                  this.$element,
                  function () {
                    t('[data-off-canvas-wrapper]').addClass(
                      'is-off-canvas-open is-open-' + n.options.position
                    ),
                ...
                this.options.trapFocus &&
                  (t('[data-off-canvas-content]').attr('tabindex', '-1'),
                  this._trapFocus());
            }
          },
        },
        ...
        },
        {
          ...
          value: function (e) {
            if (this.$element.hasClass('is-open') && !this.isRevealed) {
              var i = this;
              t('[data-off-canvas-wrapper]').removeClass(
                'is-off-canvas-open is-open-' + i.options.position
              ),
                ...
                this.options.trapFocus &&
                  t('[data-off-canvas-content]').removeAttr('tabindex');
            }
          },
        },
        {
          ...
          value: function () {
            ...
            (this.options.fullScreen || this.$element.hasClass('full')) &&
              ...
              this.$overlay
                ...
                : (this.$element.detach().appendTo(t('body')),
              ...
              this.$anchor.length &&
                this.$anchor.on('keydown.zf.reveal', function (t) {
                  (13 !== t.which && 32 !== t.which) ||
                    (t.stopPropagation(), t.preventDefault(), e.open());
                }),
              this.options.closeOnClick &&
                this.options.overlay &&
                this.$overlay
                  .off('.zf.reveal')
                  .on('click.zf.reveal', function (i) {
        ...
        },
        {
          ...
          value: function () {
                  ...
                  Foundation.Motion.animateIn(
                    ...
                    function () {
                      this.focusableElements =
                        Foundation.Keyboard.findFocusable(this.$element);
                    }
                  ))
            ...
            t('body')
              ...
              .attr(
                'aria-hidden',
                !(!this.options.overlay && !this.options.fullScreen)
              ),
              setTimeout(function () {
                e._extraHandlers();
              }, 0);
            ...
            (this.focusableElements = Foundation.Keyboard.findFocusable(
              ...
              this.$element.on('keydown.zf.reveal', function (i) {
                ...
                Foundation.Keyboard.handleKey(i, 'Reveal', {
                  tab_forward: function () {
                    e.$element.find(':focus').is(e.focusableElements.eq(-1)) &&
                      (e.focusableElements.eq(0).focus(), i.preventDefault());
                  },
                  tab_backward: function () {
                    (e.$element.find(':focus').is(e.focusableElements.eq(0)) ||
                      e.$element.is(':focus')) &&
                      (e.focusableElements.eq(-1).focus(), i.preventDefault());
                  },
                  open: function () {
                    e.$element
                      .find(':focus')
      ...
      _createClass(n, [
        {
          ...
          value: function () {
            ...
            (this.options.disabled ||
              ...
              e ||
                this._setHandlePos(this.$handle, this.options.initialStart, !0);
          },
        },
        {
          key: '_setHandlePos',
          ...
          value: function (t, n, s) {
            ...
            if (s) (o = this._adjustValue(null, s)), (a = !0);
              ...
              var r = this,
                ...
                v = e(m, f);
              if (
                ((o = (this.options.end - this.options.start) * v),
                Foundation.rtl() &&
                  !this.options.vertical &&
                  (o = this.options.end - o),
                (o = r._adjustValue(null, o)),
                (a = !1),
                !n)
              ) {
              ...
              this.options.clickSelect &&
                this.$element
                  ...
                  .on('click.zf.slider', function (e) {
                    return n.$element.data('dragging')
                      ? !1
                      : void (
                ...
                if ('number' == typeof n[o]) r = n[o];
                  ...
                  (r = u.offset().top),
                    l[1] &&
                      ...
                      (r += u[0].getBoundingClientRect().height);
                }
                s[o] = r;
              }
            else
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            ...
            if (
              ...
              i.length
                ? Foundation.onImagesLoaded(i, this._setHeight.bind(this))
                : this._setHeight();
            }
            this._events();
          },
        ...
        },
        {
          ...
          value: function () {
            this.$element
              ...
              .hide(),
              this.options.matchHeight &&
                t(window).off('changed.zf.mediaquery'),
              Foundation.unregisterPlugin(this);
          },
        },
      ]),
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            ...
            (this.options.positionClass = this._getPositionClass(
              this.$element
            )),
